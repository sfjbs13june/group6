package com.service.patient.patientservice.config;
...
public class ArtemisConfig {
    ...
    public CachingConnectionFactory cachingConnectionFactory() {
        ...
        activeMQConnectionFactory.setTrustedPackages(Collections.singletonList("com.service.patient.patientservice"));
